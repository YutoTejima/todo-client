  ...
  <div :class="$style.container">
    ...
    <form :class="$style.form">
      <label :class="$style.label">
        タイトル
        <input type="text" :class="$style.input" placeholder="タスク名" />
      </label>

      <label :class="$style.label">
        ディスクリプション
        <textarea :class="$style.input" placeholder="説明文" rows="3"></textarea>
      </label>
      ...
      <label :class="$style.label">
        タグ
        <input type="text" :class="$style.input" placeholder="タグ名" />
      </label>
      ...
      <button type="button" :class="[$style.button, $style.secondary]">キャンセル</button>
